...
def parse_args():
    ...
    parser.add_argument("--config_filename",default=project_dir+'/examples/all504/all_config_tableunet_ts.json',
    ...
    parser.add_argument("--model_filename",
                        ...
                        default=project_dir+'/models/model_softmax/all_unet3d.h5')
    parser.add_argument("--training_log_filename",
                        ...
                        default=project_dir+'/models/model_softmax/all_training_log.csv')
