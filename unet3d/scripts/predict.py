...
def format_parser(parser=argparse.ArgumentParser(), sub_command=False):
    parser.add_argument("--output_directory",default='/home/xiao/project/3DUnetCNN/output_results/output_results_all_test/fold6')
    if not sub_command:
        parser.add_argument("--config_filename", default='/home/xiao/project/3DUnetCNN/examples/all504/all_config_test.json')
        parser.add_argument("--model_filename", default='/media/xiao/DATA/models/all/model_file/fold0/all_unet3d_99.h5')
    ...
    parser.add_argument("--no_resample", default=True, action="store_true",
    ...
    parser.add_argument("--output_template",default="{subject}.nii.gz")
