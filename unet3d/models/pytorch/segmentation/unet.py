...
from ..autoencoder.variational import ConvolutionalAutoEncoder,ConvolutionalAutoEncoder_tab
...
class TableUNet(ConvolutionalAutoEncoder_tab):
    def __init__(self,input_shape=None, *args,encoder_class=UNetEncoder, decoder_class=UNetDecoder, n_outputs=1,cat_id=[],cat_dim=[], **kwargs):
        super().__init__(*args, encoder_class=encoder_class, decoder_class=decoder_class, n_outputs=n_outputs, cat_idx=cat_id,cat_dim=cat_dim,**kwargs)
        self.set_final_convolution(n_outputs=n_outputs)
