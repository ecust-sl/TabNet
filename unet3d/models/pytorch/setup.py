...
from .constants import DEFAULT_MIMIC_CLINICAL_CAT_COLS, DEFAULT_CLINICAL_NUM_COLS
...
class ModelSetup:
    ...
    use_early_stop_model: bool=True
    name: str = None
    ...
    including_clinical_num: List[str] =  field(default_factory = lambda: DEFAULT_CLINICAL_NUM_COLS)
    ...
    fusion_strategy: str = "add"  # ["add", "concat"]
