...
class TabNet(torch.nn.Module):
    def __init__(
        ...
        self.embedder = EmbeddingGenerator(input_dim,
                                           ...
                                           group_attention_matrix)
        self.post_embed_dim = self.embedder.post_embed_dim
        self.encoder = model_seg.encoder
        self.decoder = model_seg.decoder
        self.activation = model_seg.activation
        self.final_mapping = torch.nn.Linear(32768, output_dim, bias=False)
    ...
    def forward(self, img, x):
        ...
        img = self.final_convolution(img)
