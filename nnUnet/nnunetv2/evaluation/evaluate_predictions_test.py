...
def compute_metrics(reference_file: str, prediction_file: str, image_reader_writer: BaseReaderWriter,
    ...
    aspect = sitk.ReadImage('/home/xiao/nnUNet/template/T1_aspect_label_resampled2.0.nii.gz')
    ...
    for r in labels_or_regions:
        ...
        # other area
        other_mask = np.ones_like(mask_pred)
        for i in range(20):
            other_mask[aspect_np == i + 1] = 0
        mask_ref_other = mask_ref * other_mask
        mask_pred_other = mask_pred * other_mask
        tp_i, fp_i, fn_i, tn_i = compute_tp_fp_fn_tn(mask_ref_other, mask_pred_other, ignore_mask)
        results_per_area.append(2 * tp_i / (2 * tp_i + fp_i + fn_i + 1e-6))
            ###############################
        if tp + fp + fn == 0:
            ...
            results['metrics'][r]['Dice'] = 2 * tp / (2 * tp + fp + fn+1e-6)
    ...
    for i in results_per_area:
        row+=str(i)+','
    row+=str(results['metrics'][(1,)]['Dice'])
...
if __name__ == '__main__':
    # folder_ref = '/home/xiao/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset_AllTest/labelsTr'
    # folder_pred = '/home/xiao/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset_AllTest/predTs'

    folder_ref = '/home/xiao/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset505_All/labelsTs'
    folder_pred = '/home/xiao/nnUNet/nnUNetFrame/DATASET/nnUNet_raw/Dataset505_All/predTs'
    #folder_pred = '/home/xiao/nnUNet/nnUNetFrame/DATASET_test/nnUNet_trained_models/Dataset505_Test/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_0/validation'
    #output_file = '/home/xiao/nnUNet/nnUNetFrame/DATASET_test/nnUNet_raw/Dataset505_Test/summary.json'
    output_file = None
