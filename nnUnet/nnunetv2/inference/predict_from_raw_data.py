...
class nnUNetPredictor(object):
    ...
    def predict_from_files(self,
        ...
        """
        res = type(output_folder_or_list_of_truncated_output_files)
        if isinstance(output_folder_or_list_of_truncated_output_files, str):
...
if __name__ == '__main__':
    ...
    nnUNet_results = '/home/xiao/nnUNet/nnUNetFrame/DATASET/nnUNet_trained_models'
    nnUNet_raw = '/home/xiao/nnUNet/nnUNetFrame/DATASET/nnUNet_raw'
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset505_All/nnUNetTrainer__nnUNetPlans__3d_fullres'),
        #join(nnUNet_results, 'Dataset505_test/nnUNetTrainer__nnUNetPlans__3d_fullres'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, 'Dataset505_All/imagesTr'),
                                 join(nnUNet_raw, 'Dataset505_All/predTr'),
